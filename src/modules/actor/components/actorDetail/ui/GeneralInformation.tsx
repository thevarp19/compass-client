        ...
        <>
            <div className="flex flex-col gap-5 w-full">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center min-w-[311px]">
                        <h2 className="text-grayDark_text leading-[130%]">
            ...
            <div className="flex flex-col gap-5 w-full">
                ...
                <div className="flex justify-between items-center ">
                    ...
                    <h2 className="text-grayDark_text min-w-[311px]">
                        {actor?.height} см.
                    </h2>
                </div>
                <div className="flex justify-between items-center">
            ...
            <div className="flex flex-col gap-5 w-full">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <h2 className="min-w-[311px] text-grayDark_text">
