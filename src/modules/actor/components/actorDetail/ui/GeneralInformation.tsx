        ...
        <>
            <div className="flex flex-col gap-[10px] sm:gap-5 w-full">
                ...
                <div className="flex justify-between items-center gap-1 sm:gap-0">
                    ...
                    <div className="flex items-center min-w-[50%] max-w-[50%] sm:max-w-none sm:min-w-[311px]">
                        <h2 className="text-grayDark_text text-[8px] sm:text-base leading-[130%]">
            ...
            <div className="flex flex-col gap-[10px] sm:gap-5 w-full">
                ...
                <div className="flex justify-between items-center gap-1 sm:gap-0 ">
                    ...
                    <h2 className="text-[8px] sm:text-base text-grayDark_text min-w-[50%] max-w-[50%] sm:max-w-none sm:min-w-[311px]">
                        {actor?.height} см.
                    </h2>
                </div>
                <div className="flex justify-between items-center gap-1 sm:gap-0">
            ...
            <div className="flex flex-col gap-5 w-full">
                <h2 className="text-xl font-semibold text-black border-b border-gray_border leading-10">
                    {FORM_TEXT.skills}
                </h2>
                <div className="flex justify-between items-center gap-1 sm:gap-0">
                    <h2 className="text-grayDark_text">{FORM_TEXT.sport}</h2>
                    <h2 className="min-w-[50%] max-w-[50%] sm:max-w-none sm:min-w-[311px] text-grayDark_text">
            ...
            <div className="flex flex-col gap-5 w-full">
                ...
                {actor?.educations.map((education, index) => (
                    ...
                    >
                        ...
                        <div className="min-w-[50%] max-w-[50%] sm:max-w-none sm:min-w-[311px]">
                            <h2 className="text-grayDark_text">
            ...
            <div className="flex gap-5 w-full ">
                <h2 className="text-xl font-semibold text-black whitespace-pre-wrap ">
                    {FORM_TEXT.additionalInfo}
                </h2>
                <div className="min-w-[50%] max-w-[50%] sm:max-w-none sm:min-w-[311px]">
                    <h2 className="text-grayDark_text">{actor?.comments}</h2>
                </div>
            </div>
        </>
    );
